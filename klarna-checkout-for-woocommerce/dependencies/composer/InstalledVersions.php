 ...
 */
namespace KrokedilKlarnaCheckoutDeps\Composer;

use KrokedilKlarnaCheckoutDeps\Composer\Autoload\ClassLoader;
use KrokedilKlarnaCheckoutDeps\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('KrokedilKlarnaCheckoutDeps\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
