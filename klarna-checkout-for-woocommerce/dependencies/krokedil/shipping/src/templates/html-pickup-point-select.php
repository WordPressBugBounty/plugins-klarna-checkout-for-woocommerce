...
namespace KrokedilKlarnaCheckoutDeps;
...
foreach ($pickup_points as $pickup_point) {
    ...
    ?>>
				<?php 
    echo esc_html(apply_filters('krokedil_shipping_pickup_point_name', $pickup_point->get_name(), $pickup_point, $rate_id, $selected_pickup_point));
    ?>
			</option>
		<?php 
}
