...
namespace KrokedilKlarnaCheckoutDeps\Krokedil\Shipping\Frontend;

use KrokedilKlarnaCheckoutDeps\Krokedil\Shipping\AJAX;
use KrokedilKlarnaCheckoutDeps\Krokedil\Shipping\SessionHandler;
...
class PickupPointSelect
{
    ...
    public function render($shipping_rate)
    {
        ...
        if (!\in_array($shipping_rate->get_id(), WC()->session->get('chosen_shipping_methods') ?? array(), \true)) {
            return;
        }
