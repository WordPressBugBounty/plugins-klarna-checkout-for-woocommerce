...
namespace KrokedilKlarnaCheckoutDeps\Krokedil\SettingsPage;

\defined('ABSPATH') || exit;
use KrokedilKlarnaCheckoutDeps\Krokedil\SettingsPage\Traits\Singleton;
/**
...
class SettingsPage
{
    ...
    public function output($id)
    {
        ...
        try {
            ...
            // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Buffered output is generated by trusted renderers above.
